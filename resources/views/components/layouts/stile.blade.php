    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{route('inizio')}}">Home</a>
                </li>
                <li class="nav-item">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('cellulari')}}">cellulari</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('capStrutture')}}">cap-strutture</a>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    var pusher = new Pusher("d52d9505e44ac5fec817", {
        cluster: "eu",
        encrypted: true
    });
    ...
    channel.bind("import.completed", function() {
